...
<form method="post" action="{{ route('process-add-consignment') }}" enctype="multipart/form-data">
        ...
        <div class="row form-group">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control input-bb" type="hidden" name="purchase_invoice_id" id="purchase_invoice_id" onChange="function_elements_add(this.name, this.value);" value="{{ $purchase_invoice_id }}" readonly/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <a class="text-dark">Supplier</a>
                    <input class="form-control input-bb" type="text" name="supplier_name" id="supplier_name" onChange="function_elements_add(this.name, this.value);" value="{{ $Consignment->getSupplierName($PurchaseInvoice->supplier_id) }}" readonly/>
                    <input class="form-control input-bb" type="hidden" name="supplier_id" id="supplier_id" onChange="function_elements_add(this.name, this.value);" value="{{ $PurchaseInvoice->supplier_id }}"/>
                </div>
            </div>
        </div>
        <div class="row form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control input-bb" type="text" name="purchase_invoice_due_date" id="purchase_invoice_due_date" onChange="function_elements_add(this.name, this.value);" value="{{  $PurchaseInvoice->purchase_invoice_due_date  }}" readonly/>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <a class="text-dark">Tanggal Penyerahan konsinyasi</a>
                    <input class="form-control input-bb" type="date" name="sales_consignment_date" id="sales_consignment_date" onChange="function_elements_add(this.name, this.value);" value="{{ date('Y-m-d');  }}"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    @php
                      $beli = $val['quantity'] * $val['item_unit_cost']; 
                      $jual = $val['quantity'] * $val['item_unit_price'];
                      $TotalBeli += $beli;
                      $TotalJual += $jual;
                    ...
                    <tr>
                        ...
                        <td>{{ $Consignment->getCustomerName($val['customer_id']) }}
                            <input class="form-control input-bb" type="hidden" name="customer_id_{{ $no }}" id="customer_id_{{ $no }}" onChange="function_elements_add(this.name, this.value);" value="{{ $val['customer_id']  }}" readonly/>

                        </td>


                        <td>{{  $Consignment->getBarcode($val['item_id'])  }}
                        ...
                        <td>{{ $Consignment->getItemName($val['item_id'])  }} 
                        ...
                        <td>{{ $val['quantity'] }}
                            <input class="form-control input-bb" type="hidden" name="price_quantity_{{ $no }}" id="price_quantity_{{ $no }}" onChange="function_elements_add(this.name, this.value);" value="{{ $val['quantity']  }}" readonly/>
                        </td>
                        ...
                        <td>{{ number_format($val['quantity'] * $val['item_unit_cost'],2,'.',',') }}
                            <input class="form-control input-bb" type="hidden" name="total_cost_{{ $no }}" id="total_cost_{{ $no }}" onChange="function_elements_add(this.name, this.value);" value="{{ $val['quantity'] * $val['item_unit_cost'] }}" readonly/>
                        </td>

                        <td>{{ number_format($val['quantity'] * $val['item_unit_price'],2,'.',',') }}
                            <input class="form-control input-bb" type="hidden" name="total_price_{{ $no }}" id="total_price_{{ $no }}" onChange="function_elements_add(this.name, this.value);" value="{{ $val['quantity'] * $val['item_unit_price'] }}" readonly/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>{{  number_format($TotalLaba,2,'.',',') }}
                            ...
                            <input class="form-control input-bb" type="hidden" name="total_jual" id="total_jual" onChange="function_elements_add(this.name, this.value);" value="{{ $TotalJual }}" readonly/>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-secondary" href="{{ url('consignment-delivery') }}"><i class="fa fa-times"></i></i>Batal</a>
