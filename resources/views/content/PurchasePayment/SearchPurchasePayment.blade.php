...
<h3 class="page-title">
    <b>Daftar Supplier</b> <small>Mengelola Supplier</small>
</h3>
<br/>
@if(session('msg'))
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="40%" style='text-align:center'>Alamat Supplier</th>
                    ...
                    @foreach($coresupplier as $row)
                        @if ($row['total_owing_amount'] != 0)
                            <tr>
                                ...
                                <td style='text-align:right'>{{number_format($row['total_owing_amount'] - $row['total_return_amount'],2,',','.')}}</td>
