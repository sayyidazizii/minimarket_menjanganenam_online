...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Laporan Perdagangan Rugi / Laba Tahunan </li>
    </ol>
  </nav>
...
@section('content')
<h3 class="page-title">
    <b>Laporan Perdagangan Perhitungan Rugi / Laba Tahunan</b>
</h3>
<br/>
<div id="accordion">
                ...
                <thead>
                    <tr>
                        <td colspan='2' style='text-align:center;'>
                            <div style='font-weight:bold'>Laporan Perdagangan Perhitungan Rugi / Laba
                            </div>
                        </td>
                    </tr>
                    <tr>
