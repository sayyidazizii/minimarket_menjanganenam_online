...
use App\Http\Controllers\SalesMemberReport;
...
Route::prefix('si-member-report')->name('simr.')->group(function () {
    Route::get('/',  [SalesMemberReport::class,'index'])->name('index');
    Route::post('filter',  [SalesMemberReport::class,'filter'])->name('filter');
    Route::get('print',  [SalesMemberReport::class,'print'])->name('print');
    Route::get('export',  [SalesMemberReport::class,'export'])->name('export');
    Route::get('print-detail/{member_id}',  [SalesMemberReport::class,'printDetail'])->name('print-detail');
    Route::get('export-detail/{member_id}',  [SalesMemberReport::class,'exportDetail'])->name('export-detail');
    Route::get('table',  [SalesMemberReport::class,'table'])->name('table');
});